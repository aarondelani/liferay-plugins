...
<#if page_group.isUser()>
	...
	<#assign css_class = css_class + " user-group"><#assign user_detail_class = "so-user-detail">
	...
	<#if layout.isPublicLayout()>
		...
		<#assign css_class = css_class + " profile-page"><#assign user_detail_class = "user-profile-detail">

	</#if>
</#if>

<#assign layoutFluid = getterUtil.getBoolean(sessionClicks.get(request, "so-layout-fluid", "false"))>
